...
def index():
    ...
    if request.method == 'POST':
        ...
        API_KEY = '1f1ceca488cfd98b4f62bd9899724acd'  # Replace with your key
    ...
    return render_template('index.html', image_file=image_file, error=error, forecast_data=forecast_data)
